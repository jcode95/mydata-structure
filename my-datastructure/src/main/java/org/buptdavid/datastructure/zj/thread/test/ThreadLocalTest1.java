...
//                System.out.println(i+":"+date);
    ...
    public static void main(String[] args) {
        ...
        *       由于entry 的key是弱引用，这个Map的Entry继承了WeakReference,设值完成后map中是(WeakReference,value)这样的数据结构,在java中，下次GC的时候会被回收掉，回收之后变成(null,value)的形式，key被收回掉了，因此entry就存在key为null的情况，无法通过一个Key为null去访问到该entry的value
